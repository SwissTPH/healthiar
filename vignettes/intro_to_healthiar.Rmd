...
If you want to know more about the concept of tidy format, read [this article of Hadley Wickham (2014)](https://doi.org/10.18637/jss.v059.i10). 
...
For the absolute risk, the population exposed instead of baseline health data (i.e. disease-specific burden of disease) is used.
### Methodology
