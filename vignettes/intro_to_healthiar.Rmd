...
*Note*: The function arguments `erf_eq_...` require a function as input. This can be fulfilled by using a 'function(c)' which is of type 'function'.
...
The function created is equal to
$$
f(c) =
\begin{cases}
1, & c < \text{threshold} \\
