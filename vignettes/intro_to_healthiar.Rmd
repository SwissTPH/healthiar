...
*Note*: Although `healthiar` tried to allign methodologically with AirQ+, 
the results using the life table marginally differ 
(being AirQ+ around 0.02% higher per 1,000 attributable deaths or 0.05% per 1,000 YLL). 
The reasons of this minor variance are unknown, 
altough it might be caused (at least partly) to different rounding
strategies.
