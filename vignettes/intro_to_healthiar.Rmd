...
* $RR(x)$ = relative risk at exposure level compared to reference
...
The single exposure value corresponds to the Population Weighted Mean Concentration (PWC)

$$PAF = \frac{RR_{PWC} - 1}{RR_{PWC}}$$

For conversion of hazard ratios and/or odds ratios to relative risks refer to [@VanderWeele2019] and/or use the conversion tools developed by the Teaching group in EBM in 2022 for hazard ratios (https://ebm-helper.cn/en/Conv/HR_RR.html) and/or odds ratios (https://ebm-helper.cn/en/Conv/OR_RR.html).
...
### Method
To quantify the YLDs, you can use a prevalence-based or an incidence-based approach [@Kim2022].
