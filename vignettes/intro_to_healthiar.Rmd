...
AirQ+ [@WHO2020_report]. In standard AirQ+ life table disaggregations, deaths are assumed to be distributed uniformly across age intervals with a fraction of the age interval lived of 0.5. 
However, in modern public health settings, infant mortality is highly skewed because the vast majority of deaths occur within the first year of life. In countries with low infant mortality the fraction lived can be e.g. 0.1.
