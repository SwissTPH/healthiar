...
the results using the life table marginally differ slightly
(AirQ+ results are around 0.02% higher per 1,000 attributable deaths or
0.05% per 1,000 YLL). 
The reason for this minor variance is unknown. A different rounding 
strategy might be behind (at least in part).
