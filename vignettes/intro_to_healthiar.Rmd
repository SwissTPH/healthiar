...
`healthiar`, while the YLL of the year of analysis alone differ by less than
0.1%). Part of this deviation may be explained by the treatment of the last
(open-ended) age group described above, which is a known source of deviation
between health impact assessments [@Miller2003_jech]. The remaining part is
unknown. A different rounding strategy might also contribute marginally to the deviation.
