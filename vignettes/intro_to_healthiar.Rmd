...
output_attribute <- attribute_health(
  ...
  exp_central = c(6, 7, 8,
                  7, 8, 9,
                  8, 9, 10,
                  9, 10, 11), # One value for each geo_id and education level
  bhd_central = c(600, 700, 800,
                  700, 800, 900,
                  800, 900, 1000,
                  900, 1000, 1100), # One value for each geo_id and education level
  geo_id_micro = base::rep(c(1, 2, 3, 4), each = 3), 
  info = info # education level
  ) 
