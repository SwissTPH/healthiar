...
::: fragment
Slides and exercises can be downloaded from [this folder on the healthiar GitHub page](https://github.com/SwissTPH/healthiar/tree/master/varia/Workshops_and_demos/workshop) (link also in the last email and in the Zoom chat)
:::

::: fragment
Run the following commands below in RStudio to install *healthiar*
(also found at the start of the exercises)
