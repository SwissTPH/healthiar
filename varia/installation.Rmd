...
# Install healthiar from public GitHub

```{r}
## Avoid that PAT is used in installation
...
# Install healthiar from private GitHub
...
remotes::install_github(
  ...
  ref = "1257-add-method-references-to-the-description-field-of-the-description-file", # By default "HEAD"; name of branch to install package from as a string
  force = TRUE,
...
remotes::install_github(
  repo = "SwissTPH/healthiar",
  # ref = "HEAD", # By default "HEAD"; name of branch to install package from as a string
  ref = "519-add-examples-to-the-function-descriptions", # By default "HEAD"; name of branch to install package from as a string
  force = TRUE,
  # auth_token = "", # Paste your GitHub PAT between the quotation marks
  # dependencies = TRUE,
  # build_vignettes = TRUE,
