...
```{r}
load("../varia/Performance/Compare ARE method with new method/workspace.RData")
...
#   prof_output = "../varia/Performance/Compare ARE method with new method/PER new method.Rprof",
# )

profvis(prof_input="../varia/Performance/2023-12-13 Compare ARE method with new method/PER new method.Rprof")
```
