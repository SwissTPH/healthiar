...
# load("../varia/comparison_lifetable_approaches/input_data_get_pop_impact.Rdata")
load("../varia/comparison_lifetable_approaches/documentation_AirQ+_and_GeLuft_approaches.Rdata")
options(digits = 10)
