...
percentage_pm2.5_in_pm10 <- 
  read.csv("../varia/input/data/generic_data.csv", sep = ";") %>% 
...
rr_rawdata <- 
  read.csv("../varia/input/data/rr.csv",
           sep = ";",
           na.strings=c("NA", ""))

# Population data by age (To be used in the life table approach)
population_byAge_rawdata <-
  read.csv2("../varia/input/data/population/population_byAge_bySex_CH_2018_2019.csv") %>%
  # Rename columns
...
bhd_rawdata <- 
  read.csv("../varia/input/data/bhd.csv", sep = ";")
...
for(s in sex){
  ...
  lifetable[[s]] <- 
    read.csv2(
      ...
      paste0("../varia/input/data/life_tables/life_table_2013_2020_",
             s,
             ".csv"))
}
...
nonNatural_mortality_rawdata<- 
   list(
     male = read.csv2("../varia/input/data/mortality/nonNatural_mortality_byAge_2009_2019_male.csv",
                      na.strings =".", 
                      check.names = FALSE),
     female = read.csv2("../varia/input/data/mortality/nonNatural_mortality_byAge_2009_2019_female.csv",
                        na.strings =".", 
                      check.names = FALSE))
...
total_mortality_rawdata <- 
  list(
    male = read.csv2("../varia/input/data/mortality/total_mortality_byAge_2009_2019_male.csv",
                     na.strings =".", 
                      check.names = FALSE),
    female = read.csv2("../varia/input/data/mortality/total_mortality_byAge_2009_2019_female.csv",
                       na.strings =".", 
                      check.names = FALSE))
...
# Scenario
exp_rawdata <- 
  read.csv("../varia/input/data/exp.csv",
           sep = ";",
           na.strings=c("NA", ""))
...
cutoff_rawdata <- 
  # Read data
  read.csv("../varia/input/data/cutoff.csv",
           sep = ";",
           na.strings=c("NA", ""))
...
airqplus_copd_export <-
  ...
  readr::read_delim("../varia/input/airqplus_cases/airqplus_COPD.csv",
                    delim = ";",
                    col_types = cols())
...
airqplus_deaths_pop_multipleYear <-
  read.csv2("../varia/input/airqplus_cases/airqplus_manual_multipleYear.csv")
airqplus_deaths_pop_singleYear <-
  read.csv2("../varia/input/airqplus_cases/airqplus_manual_age0to40_singleYear.csv")
...
airqplus_deaths_yll_export <-
  readr::read_delim(
    # "../varia/airqplus_cases/airqplus_deaths_yll_lifetable_adults.csv", # OLD PATH
    "../varia/input/airqplus_cases/airqplus_deaths_yll_lifetable_adults.csv",
    delim = ";",
...
niph_noise_ha_excel <-
  # Read csv file
  readxl::read_xlsx(path = "../varia/input/noise_niph/example_road_noise_niph.xlsx",
...
mrbrt_stroke <- readRDS(file = "../varia/input/MRBRT_stroke.RDS")
```
...
pop_data_norway <- readRDS(file = "../varia/input/pop_data.RDS")
```
...
exdat_get_mdi <- read.csv("../varia/input/data/mdi/Belgium_MDI_2021.csv")
```
...
#                   "pop_data_norway"
#                   )))
# save.image(file = "../varia/input/data/input_data_for_testing_Rpackage.RData")
```
