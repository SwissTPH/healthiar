...
percentage_pm2.5_in_pm10 <- 
  read.csv("varia/archive/input/data/generic_data.csv", sep = ";") %>% 
...
rr_rawdata <- 
  read.csv("varia/archive/input/data/rr.csv",
           sep = ";",
           na.strings=c("NA", ""))
...
bhd_rawdata <- 
  read.csv("varia/archive/input/data/bhd.csv", sep = ";")
...
# Scenario
exp_rawdata <- 
  read.csv("varia/archive/input/data/exp.csv",
           sep = ";",
           na.strings=c("NA", ""))
...
cutoff_rawdata <- 
  # Read data
  read.csv("varia/archive/input/data/cutoff.csv",
           sep = ";",
           na.strings=c("NA", ""))
...
mrbrt_stroke <- readRDS(file = "varia/archive/input/MRBRT_stroke.RDS")
```
...
pop_data_norway <- readRDS(file = "varia/archive/input/pop_data.RDS")
```
...
#                   "pop_data_norway"
#                   )))
# save.image(file = "varia/archive/input/data/input_data_for_testing_Rpackage.RData")
```
