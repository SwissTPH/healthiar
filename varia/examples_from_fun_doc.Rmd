...
results <- healthiar::attribute_health(
  geo_id_micro = c("Zurich", "Basel", "Geneva", "Ticino", "Valais"),
  geo_id_macro = c("Ger","Ger","Fra","Ita","Fra"),
  rr_central = 1.369,
  rr_increment = 10,
  cutoff_central = 5,
  erf_shape = "log_linear",
...
results <- compare(
  output_attribute_scen_1 = output_attribute_1,
  output_attribute_scen_2 = output_attribute_2,
...
results <- multiexpose(
  output_attribute_exp_1 = output_attribute_1,
  output_attribute_exp_2 = output_attribute_2,
  exp_name_1 = "pm2.5",
  exp_name_2 = "no2",
