...
# direct approach. 
# valuation=1 to compare results with only discounting
bestcost_pm_yll_lifetable_geluft_direct_discount <-
  healthiar::monetize(
    approach_discount = "direct",
    output_healthiar = bestcost_pm_yll_exposure_single_year_lifetable_geluft,
    discount_shape = "exponential",
...
check_general(bestcost_pm_yll_lifetable_geluft_direct_discount[["monetization_main"]]$monetized_impact_rounded,
              c(29275, 15328, 43119))# Result on 25 March 2025.
