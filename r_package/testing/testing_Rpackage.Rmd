...
## Install current version of {healthiar}
### If prompted to update or install packages please do so
### First detach the healthiar package
devtools::install_github(
  ...
  ref = "432-terra-package-required-for-installing-healthiar",
  # force = TRUE,
  # dependencies = TRUE,
...
scen_a <-
  attribute_health(
    ...
    rr_increment = 10,
    exp_central = 8.85, exp_lower = NULL, exp_upper = NULL,
    cutoff_central = 5, cutoff_lower = NULL, cutoff_upper = NULL,
    bhd_central = 25000
  )
...
scen_b <-
  attribute_health(
    ...
    rr_central = 1.118, rr_lower = 1.060, rr_upper = 1.179,
    rr_increment = 10,
    exp_central = 6, exp_lower = NULL, exp_upper = NULL,
    cutoff_central = 5, cutoff_lower = NULL, cutoff_upper = NULL,
    bhd_central = 25000
  )
...
test_comparison <- 
  compare_health_new(
    output_attribute_scen_A = scen_a,
    output_attribute_scen_B = scen_b
  )
...
bestcost_pm_copd_cba <-
  healthiar::include_cba(
    ...
    discount_overtime = "last_year")
check_general(bestcost_pm_copd_cba[["cba_main"]]$benefit_minus_cost_rounded,
