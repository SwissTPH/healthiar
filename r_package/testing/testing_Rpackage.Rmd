...
# Discounting with different cost dending on the year 
# following example of University of Porto
bestcost_inflation_different_cost_by_year <- 
  healthiar::include_monetization(
    approach_discount = "direct",
...
check_general(round(bestcost_inflation_different_cost_by_year[["monetization_detailed"]]$monetized_impact),
