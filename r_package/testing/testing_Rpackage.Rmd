...
check_bestcost(result_list_bestcost = bestcost_pm_daly,
...
scen_2_daly  <- 
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = scen_1_daly,
    exp_central = 6)

comparison_daly_delta  <-
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_daly, 
    output_attribute_scen_2 = scen_2_daly)
...
scen_2_daly_geo  <- 
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = scen_1_daly_geo,
    exp_central = list(6, 6.5))# Fake data just for testing purposes

comparison_daly_delta_geo  <-
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_daly_geo, 
    output_attribute_scen_2 = scen_2_daly_geo)
