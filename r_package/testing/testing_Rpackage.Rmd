...
remotes::install_github(
  ...
  ref = "613-add-a-news-file-to-our-package", # By default "HEAD"; name of branch to install package from as a string
  force = TRUE,
...
# devtools::build(binary = TRUE, path = "../testing/Workshops_and_demos/WS_WP5/ws_2/") # Save current state of package as .zip file (e.g. to directly test changes in functions)
