...
check_general(
  ...
  a = bestcost_pm_death_social_decile[["social_main"]][["original_layout"]]$difference_value,
...
check_general(bestcost_pm_copd_costs_discount[["monetization_main"]]$monetized_impact_rounded,
              c(3399306, 1313402, 5313428)) # Result on 8 Jan 2025
...
bestcost_pm_copd_cost_discount_single_value <- 
  healthiar::include_monetization(approach_discount = "direct",
                          ...
                          discount_years = 20,
                          valuation = 1)
check_general(bestcost_pm_copd_cost_discount_single_value$monetized_impact_rounded,
              14877)
...
# Indirect approach. 
## Discounting without monetization (valuation=1) to compare results
...
check_general(bestcost_pm_copd_discount$monetized_impact_rounded,
              14877)
