...
remotes::install_github(
  ...
  # ref = "463-create-get_mdi-function",
  force = TRUE,
...
# Deactivated feature. To be decided.
# DALY based on DALY, i.e. using DALY in the bhd, same as attribute_health()
#
# bestcost_daly_from_daly <-
#   healthiar::attribute_daly(
#     exp_central = 8.85,
#     cutoff_central = 5,
#     bhd_central = 30747,
...
#     erf_shape = "log_linear")
# 
# check_bestcost(result_list_bestcost = bestcost_daly_from_daly,
#                result_vector_alternative = c(3502, 1353, 5474))
...
bestcost_pm_daly_from_lifetable  <- 
...
check_bestcost(result_list_bestcost = bestcost_pm_daly_from_lifetable,
...
# You can also first store the variables and enter them in attribute() 
...
comparison_singlebhd_rr_delta_packed <- 
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_singlebhd_rr_delta,
    output_attribute_scen_2 = scen_2_singlebhd_rr_delta,
...
# And even easier: using a the function attribute_scen2_from_scen1
...
scen_2_singlebhd_rr_delta_helper <-
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = scen_1_singlebhd_rr_delta,
...
comparison_singlebhd_rr_delta_packed_helper <- 
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_singlebhd_rr_delta,
    output_attribute_scen_2 = scen_2_singlebhd_rr_delta_helper,
    approach_comparison = "delta")
...
comparison_singlebhd_rr_delta_same_impact <-
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_singlebhd_rr_delta,
    output_attribute_scen_2 = scen_1_singlebhd_rr_delta)
...
scen_1_singlebhd_ar_geo <-
  healthiar::attribute_health(
    ...
    prop_pop_exp= list(c(387500, 286000, 191800, 72200, 7700)/945200, 
...
# DELTA
scen_1_yld_lifetable <-
  healthiar::attribute_yld_from_lifetable(
    exp_central = 8.85, # Fake data just for testing purposes
    prop_pop_exp = 1, # Fake data just for testing purposes
    cutoff_central = 5,   # PM2.5=5, WHO AQG 2021 
    rr_central = 1.118,
...
scen_2_yld_lifetable <-
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = scen_1_yld_lifetable,
    exp_central = 6) # Fake data just for testing purposes

comparison_yld_lifetable_delta <- 
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_yld_lifetable,
    output_attribute_scen_2 = scen_2_yld_lifetable)
...
scen_1_yld_lifetable_geo <-
  healthiar::attribute_yld_from_lifetable(
    ...
    min_age = 20,
    duration_central = 100,
    dw_central = 1,geo_id_disaggregated = c("a", "b"),
    geo_id_aggregated = rep("ch", 2))

scen_2_yld_lifetable_geo <-
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = scen_1_yld_lifetable_geo,
    exp_central = list(6, 6.5))# Fake data just for testing purposes

comparison_yld_lifetable_delta_geo <- 
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_yld_lifetable_geo,
    output_attribute_scen_2 = scen_2_yld_lifetable_geo)
...
scen_2_yll <-
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = bestcost_pm_yll,
    exp_central = 6)
...
scen_2_yld <-
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = bestcost_pm_yld,
    exp_central = 6)
...
check_bestcost(result_list_bestcost = comparison_daly_delta ,
               result_vector_alternative = c(24738, 12977, 36370)) # Result on 18 March 2025
...
check_bestcost(result_list_bestcost = comparison_daly_pif,
               result_vector_alternative = c(24827, 13001, 36563 )) # Result on 18 March 2025
...
check_bestcost(result_list_bestcost = comparison_daly_delta_geo ,
               result_vector_alternative = c(34742, 18219, 51093 )) # Result on 18 March 2025
...
check_bestcost(result_list_bestcost = comparison_daly_pif_geo,
               result_vector_alternative = c(34890, 18260, 51415)) # Result on 18 March 2025


scen_1_daly_from_lifetable  <- 
  healthiar::attribute_daly_from_lifetable(
    exp_central = 8.85,
    prop_pop_exp = 1,
    cutoff_central = 5,
    rr_central =  1.118, 
...
scen_2_daly_from_lifetable  <- 
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = scen_1_daly_from_lifetable,
    exp_central = 6)

comparison_daly_delta_from_lifetable  <-
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_daly_from_lifetable, 
    output_attribute_scen_2 = scen_2_daly_from_lifetable)

# No study to compare bestcost results
# Check only if results stay the same overtime despite developments
check_bestcost(result_list_bestcost = comparison_daly_delta_from_lifetable ,
...
# Iteration
scen_1_daly_geo_from_lifetable  <- 
  healthiar::attribute_daly_from_lifetable(
    exp_central = list(8.85, 8.0),
    cutoff_central = 5,
    rr_central =  1.118, 
...
scen_2_daly_geo_from_lifetable  <- 
  healthiar::attribute_scen2_from_scen1(
    output_attribute_scen_1 = scen_1_daly_geo_from_lifetable,
    exp_central = list(6, 6.5))# Fake data just for testing purposes

comparison_daly_delta_geo_from_lifetable  <-
  healthiar::compare_health_new(
    output_attribute_scen_1 = scen_1_daly_geo_from_lifetable, 
    output_attribute_scen_2 = scen_2_daly_geo_from_lifetable)

# No study to compare bestcost results
# Check only if results stay the same overtime despite developments
check_bestcost(result_list_bestcost = comparison_daly_delta_geo_from_lifetable,
               result_vector_alternative = c(66082, 34618, 97279)) # Result on 20 August 2024

# PIF
comparison_daly_pif_from_lifetable  <-
  healthiar::compare_health_new(
    approach_comparison = "pif",
    output_attribute_scen_1 = scen_1_daly_from_lifetable, 
    output_attribute_scen_2 = scen_2_daly_from_lifetable)
...
# No study to compare bestcost results
# Check only if results stay the same overtime despite developments
check_bestcost(result_list_bestcost = comparison_daly_pif_from_lifetable,
               result_vector_alternative = c(43396, 22708, 63957 )) # Result on 20 August 2024


# Iteration
comparison_daly_pif_geo_from_lifetable  <-
  healthiar::compare_health_new(
    approach_comparison = "pif",
    output_attribute_scen_1 = scen_1_daly_geo_from_lifetable, 
    output_attribute_scen_2 = scen_2_daly_geo_from_lifetable)
...
# No study to compare bestcost results
# Check only if results stay the same overtime despite developments
check_bestcost(result_list_bestcost = comparison_daly_pif_geo_from_lifetable,
...
check_general(bestcost_cost_discount_single_value[["monetization_main"]]$monetized_impact_rounded,
              11074)
## Results according to ChatGPT on 10 March 2025
