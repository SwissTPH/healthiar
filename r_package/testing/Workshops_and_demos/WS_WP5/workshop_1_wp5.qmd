...
![](images/attribute_health_simple.png){width="500"}
:::
...
:::::: columns
::: {.column .fragment .fade-in width="60%"}
...
::: {.fragment}
*Advanced* 
How large is the health burden measured in YLD? 
...
::: {.fragment}
For the workshop next week, please **install & test healthiar**, because you will have to programm in RStudio!
