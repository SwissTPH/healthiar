...
The main function family of `healthiar` is the `attribute` family, used to attribute health impacts to a (environmental) risk factor, e.g. noise or air pollution. 
The core function `attribute_health` can be used for most assessments.
