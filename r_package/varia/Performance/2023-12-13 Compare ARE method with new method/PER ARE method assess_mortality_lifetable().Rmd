...
```{r}
load("varia/input/performance/PER assess_mortality_lifetable() data.RData")
...
profvis(prof_input="../varia/Performance/2023-12-13 Compare ARE method with new method/PER ARE method.Rprof")
```
