...
#devtools::build(binary = TRUE, path = "../varia/Performance/2023-12-20 Implemented 'small changes'/")

# Load input data for function to be tested
load("../varia/Performance/2023-12-20 Implemented 'small changes'/data.Rdata")

# Install package (specify location where the .zip file was saved to)
install.packages("C:/Users/luytax/switchdrive/bestcost_euproject/r_package/varia/Performance/2023-12-20 Implemented 'small changes'/bestcost_0.0.0.1.zip",
                 repos=NULL,
                 type='source'
                 )
...
profvis(bestcost::assess_mortality_lifetable(
  ...
  # prof_output = "../varia/Performance/2023-12-20 Implemented 'small changes'/PER.Rprof"
)

profvis(prof_input="../varia/Performance/2023-12-20 Implemented 'small changes'/PER.Rprof") # Current version

profvis(prof_input="../varia/Performance/2023-12-13 Compare ARE method with new method/PER new method.Rprof") # Old version

profvis(prof_input="../varia/Performance/2023-12-13 Compare ARE method with new method/PER ARE method.Rprof") # Initial version
```
