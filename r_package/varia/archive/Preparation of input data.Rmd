...
```{r Add data for testing get_mdi function}
...
exdat_input_2 <- input_data_mortality
exdat_pop_male <- lifetable_withPopulation[["male"]]
exdat_pop_female <- lifetable_withPopulation[["female"]]
exdat_erf <- mrbrt_stroke
exdat_noise_ha <- niph_noise_ha_excel |> 
  dplyr::filter(!is.na(niph_noise_ha_excel$exposure_mean))
exdat_noise_ihd <- niph_noise_ihd_excel
exdat_pop_2 <- pop_data_norway
