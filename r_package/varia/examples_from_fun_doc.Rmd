...
# Goal: determine attributable pre-mature deaths due to air pollution exposure during one year using the life table approach
...
results <- attribute_lifetable(
  ...
  cutoff_central = exdat_input_2$cutoff[2], # WHO AQG 2021
