...
To iterate an burden or impact assessment over multiple geo(graphic) units the geo-specific information, such as the `exp_...` and `bhd_...` arguments, have to be entered as a list, i.e. wrapped by the `as.list` function.
