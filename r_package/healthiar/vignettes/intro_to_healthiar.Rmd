...
results_pm_yll$health_detailed$results_raw$yll_nest$total_a_central_central_central |> 
  ...
  slice( ( nrow(results_pm_yll$health_detailed$results_raw$yll_nest$total_a_central_central_central)-8 ) : 
           nrow(results_pm_yll$health_detailed$results_raw$yll_nest$total_a_central_central_central)) |> 
  knitr::kable()
```
...
- `results_pm_yll[["health_detailed"]][["results_raw"]][["premature_deaths_nest"]][["total_a_central_central_central"]] |> select(age, age_end, deaths_2019)` pre-mature deaths in the year of exposure (here: 2019) attributable to exposure
