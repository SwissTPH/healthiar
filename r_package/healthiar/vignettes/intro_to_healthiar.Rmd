...
results_pm_yll <- attribute_lifetable(
  ...
  population = c(exdat_pop_1$midyear_population_male,
...
```{r eval=FALSE, include=FALSE, echo=TRUE}
results_pm_yll$health_detailed$results_raw$pop_exposed_scenario_nest$female_a_central_central_central_central
```
...
results_pm_yll$health_detailed$results_raw$pop_exposed_scenario_nest$female_a_central_central_central_central |>    
  dplyr::select(age_start, population_2019, population_2020, population_2021, population_2022) |>    
  dplyr::slice(
    ( nrow(results_pm_yll$health_detailed$results_raw$pop_exposed_scenario_nest$female_a_central_central_central_central ) -8 ) : 
      nrow(results_pm_yll$health_detailed$results_raw$pop_exposed_scenario_nest$female_a_central_central_central_central )
    ) |>    
  knitr::kable()
```
...
```{r eval=FALSE, include=FALSE, echo=TRUE}
results_pm_yll$health_detailed$results_raw$pop_unexposed_scenario_nest$female_a_central_central_central_central
```
...
results_pm_yll$health_detailed$results_raw$pop_unexposed_scenario_nest$female_a_central_central_central_central |>    
  dplyr::select(age_start, population_2019, population_2020, population_2021, population_2022) |>    
  dplyr::slice(
    ( nrow(results_pm_yll$health_detailed$results_raw$pop_unexposed_scenario_nest$female_a_central_central_central_central ) -8 ) : 
      nrow(results_pm_yll$health_detailed$results_raw$pop_unexposed_scenario_nest$female_a_central_central_central_central )
    ) |>    
  knitr::kable()
```
