...
*NOTE*: the development of `healthiar` is still ongoing. Any feedback, e.g. regarding bugs or unclear documentation, is welcome and highly appreciated. Please provide feedback via a [GitHub issue](https://github.com/best-cost/best-cost_WPs/issues).
...
-   `health_detailed` detailed results and additional info about the assessment
    ...
    -   `results_by_...`
        ...
        - `age_group`: contains results by age groups (only present if function argument `age` sepcified)
...
*NOTE*: to obtain age-group-specific results, the baseline health data (and possibly exposure) must be entered by age group.
