...
-   *discount_rate_benefit* specifies whether discounting for future years is done for the entered benefit

    -   if yes –\> TRUE
    -   if no –\> FALSE
    
-   *discount_rate_cost* specifies whether discounting for future years is done for the entered cost
