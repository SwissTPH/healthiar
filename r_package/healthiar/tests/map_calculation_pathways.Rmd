...
existing_tests <- tibble(
  ...
  cutoff = rep(NA_character_, n_row),
  varuncer = rep(NA_character_, n_row),
...
pathways_rr <- pathways_rr |> 
  ...
  arrange(desc(implemented), desc(core_pathway), erf, desc(exp), desc(cutoff), desc(varuncer), desc(iteration))
...
n_row <- length(test_names_with_pw)
existing_tests <- tibble(
  discount_appr = rep(NA_character_, n_row),
