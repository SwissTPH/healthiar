...
testthat::test_that("results correct yld pathway_uncertainty|exp_single|erf_rr_increment|iteration_FALSE|distribution_normal|", {
  ...
  bestcost_pm_yld_singlebhd_with_summary_uncertainty  <-
    healthiar::attribute_health(
      ...
      cutoff_lower = data$cut_off_value - 1,
      cutoff_upper = data$cut_off_value + 1,
      bhd_central = data$incidents_per_100_000_per_year/1E5*airqplus_pm_copd$population_at_risk,
      bhd_lower = (data$incidents_per_100_000_per_year/1E5*airqplus_pm_copd$population_at_risk) - 5000,
      bhd_upper = (data$incidents_per_100_000_per_year/1E5*airqplus_pm_copd$population_at_risk) + 5000,
      rr_central = 1.118,
      rr_lower = 1.060,
      rr_upper = 1.179,
      rr_increment = 10,
