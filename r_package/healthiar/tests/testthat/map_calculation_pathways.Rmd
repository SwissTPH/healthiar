...
```{r Create Excel for teams folder}
...
names(pathways_list) <- c("pathways_rr", "pathways_ar", "pathways_cba")

hs <- openxlsx::createStyle(textDecoration = "bold") # hs = header style

openxlsx::write.xlsx(pathways_list, "tests/pathways_overview.xlsx",
                     headerStyle = hs,
