...
#' @param listed_output_healthiar \code{List} containing as sub-lists the results of \code{healthiar::attribute_health()} or \code{healthiar::compare()} for each age group. Each list element should refer to one specific age group.#'
