...
#' @param bhd_central,bhd_lower,bhd_upper \code{Numeric value(s)} providing the baseline health data of the health outcome of interest in the study population and (optionally) the corresponding lower bound and the upper 5\% confidence interval bounds. Generally, the health metric you put in (e.g. disease cases (absolute or rate), deaths, DALYs, prevalence, incidence, ...) is the one you get out.
