...
Before starting here, please have read carefully the information
provided in
[README.md](https://github.com/SwissTPH/healthiar/blob/master/README.md)
...
impacts of environmental stressors (air pollution & noise)
...
- [`summarize_uncertainty()`](https://swisstph.github.io/healthiar/dev/reference/summarize_uncertainty.md)
  performs a Monte Carlo simulation
- [`compare()`](https://swisstph.github.io/healthiar/dev/reference/compare.md)
  compares health impacts of two scenarios (via PAF or PIF approaches)
- [`monetize()`](https://swisstph.github.io/healthiar/dev/reference/monetize.md)
  monetizes health impacts
- [`attribute_lifetable()`](https://swisstph.github.io/healthiar/dev/reference/attribute_lifetable.md)
  quantifies health impacts by applying the life table method (RR & AR)
- [`attribute_mod()`](https://swisstph.github.io/healthiar/dev/reference/attribute_mod.md)
  modifies an existing
  [`attribute_health()`](https://swisstph.github.io/healthiar/dev/reference/attribute_health.md)
  assessment
- [`cba()`](https://swisstph.github.io/healthiar/dev/reference/cba.md)
  performs a cost-benefit analysis
- `get_daly()` adds up YLL & YLD to obtain DALY
- [`multiexpose()`](https://swisstph.github.io/healthiar/dev/reference/multiexpose.md)
...
- [`prepare_mdi()`](https://swisstph.github.io/healthiar/dev/reference/prepare_mdi.md)
...
*Note*: most `healthiar` functions have examples that you can execute
(with `healthiar` loaded) by running `example("function_name")`,
e.g. `example("attribute_health")`

*Note*: healthiar functions are easiest to use if your data is prepared
in a tidy format:
...
information about the assessment, such as intermediate results and
...
Now we will make a similar function call, but include uncertainty in
...
section \[Example: attribute_health() with user-defined ERF\])
...
(See \[Example: attribute_health() for multiple geographic units with
relative risk\] for a more detailed explanation of multiple geo unit
assessments)

Goal: attribute high annoyance cases to noise exposure in rural and
urban areas
...
*NOTE*: to obtain age-group-specific results, the baseline health data
(and possibly exposure) must be available by age group.
...
*NOTE*: to obtain sex-specific results, the baseline health data (and
...
*Note*: a (random) ID vector of unique values must be entered to the
argument `geo_id_micro`, to indicate that each row is an observation on
its own (and not just exposure categories)
...
exmaple, this will be information about the education level.
...
Goal: attribute COPD cases to air pollution exposure by applying a
user-defined exposure response function (e.g. MR-BRT curves from Global
Burden of Disease study)

*Note*: in this case, the function arguments `erf_eq_...` require a
function as input, so we use an auxiliary function
([`splinefun()`](https://rdrr.io/r/stats/splinefun.html)) to transform
the points on the ERF into type `fucntion`.
...
You can do a Monte Carlo uncertainty analysis via the
...
|:-------------|:-----------------|---------:|---------------:|
| a            | central_estimate | 3508.711 |           3509 |
| a            | lower_estimate   | 1658.747 |           1659 |
| a            | upper_estimate   | 5632.217 |           5632 |
...
|:---|:---|:---|:---|:---|---:|:---|:---|---:|---:|---:|:---|---:|:---|---:|---:|:---|---:|:---|---:|---:|---:|---:|:---|---:|---:|
| a | central | central | central | central | 1 | all | all | 1 | 3826.540 | 3827 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.491877 | 8.458263 | 29617.22 | paf | 1.148369 | 0.1291998 |
| a | central | central | central | central | 1 | all | all | 2 | 3849.678 | 3850 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.472163 | 8.278704 | 32326.18 | paf | 1.135188 | 0.1190886 |
| a | central | central | central | central | 1 | all | all | 3 | 3221.669 | 3222 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.372315 | 8.621336 | 29750.22 | paf | 1.121442 | 0.1082906 |
| a | central | central | central | central | 1 | all | all | 4 | 1183.768 | 1184 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.101098 | 9.090686 | 30643.42 | paf | 1.040183 | 0.0386304 |
| a | central | central | central | central | 1 | all | all | 5 | 3391.939 | 3392 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.432440 | 8.247698 | 30790.52 | paf | 1.123800 | 0.1101618 |
| a | central | central | central | central | 1 | all | all | 6 | 5072.865 | 5073 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.516085 | 9.600145 | 29117.67 | paf | 1.210976 | 0.1742195 |
| a | central | central | central | central | 1 | all | all | 7 | 2274.894 | 2275 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.268239 | 8.180896 | 31248.00 | paf | 1.078517 | 0.0728013 |
| a | central | central | central | central | 1 | all | all | 8 | 2932.166 | 2932 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.296759 | 8.800752 | 31177.22 | paf | 1.103812 | 0.0940484 |
| a | central | central | central | central | 1 | all | all | 9 | 4383.840 | 4384 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.329638 | 10.059063 | 32659.18 | paf | 1.155041 | 0.1342299 |
| a | central | central | central | central | 1 | all | all | 10 | 3834.615 | 3835 | relative_risk | 10 | log_linear | 1 | 1 | population_weighted_mean | 5 | FALSE | 1 | 1.347838 | 9.304410 | 31802.65 | paf | 1.137107 | 0.1205753 |

### Example: `monetize()`

Goal: determine monetized attributable health impact of a policy that
...
Goal: determine the net-benefit of a health policy via cost-benefit
analysis (CBA) using previous results
...
Goal: determine years of life lost (YLL) due to deaths from COPD
...
Goal: determine premature deaths from COPD attributable to PM2.5
