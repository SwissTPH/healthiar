...
#' @param erf_shape
#' \code{String value} specifying the \strong{exposure-response function shape} to be assumed. Options (no default): \code{"linear"}, \code{log_linear}", \code{"linear_log"}, \code{"log_log"}. Input exposure values must be expressed in same unit as the increment of the relative risk. \emph{Only applicable in RR pathways; not required if \code{erf_eq_...} argument(s) already specified.}
