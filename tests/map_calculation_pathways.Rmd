...
for (i in seq_along(test_names_with_pw)) {
  ...
  existing_tests$inflation[i] <- str_extract(strings[str_detect(strings, "\\|inflation_rate_")], "(?<=\\|inflation_)[^\\|]+")
...
openxlsx::write.xlsx(progress_overall, "tests/progress_overall.xlsx")
```
